    ...
    <div class="modal-content animated-modal" @click.stop>
      ...
      <div class="modal-body">
        <div class="form-group">
          <label for="name" class="bold-label">Tên giải thưởng</label>
          <input type="text" id="name" v-model="searchData.name" class="form-control small-input" placeholder="Vui lòng nhập giải thưởng" />
        </div>
