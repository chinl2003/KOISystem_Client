<template>
    <div class="modal-overlay" @click.self="closeModal">
        <div class="modal-content">
            ...
            <h2 class="form-title">THÊM HẠNG THI ĐẤU</h2>
            <form @submit.prevent="submitForm">
                <div class="form-group">
                    <label for="name">Tên hạng thi đấu:<span class="required">*</span></label>
                    <input type="text" id="competitionName" v-model="form.competitionName" required placeholder="Vui lòng nhập tên hạng thi đấu...">
                </div>
