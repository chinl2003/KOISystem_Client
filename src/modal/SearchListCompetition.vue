      ...
      <div class="modal-content animated-modal" @click.stop>
        ...
        <div class="modal-body">
          <div class="form-group">
            <label for="name" class="bold-label">Tên cuộc thi</label>
            <input type="text" id="name" v-model="searchData.name" class="form-control small-input" placeholder="Vui lòng nhập cuộc thi" />
          </div>
          <div class="form-group">
            <label for="status" class="bold-label">Trạng thái</label>
            <select id="competitionStatus" v-model="searchData.status" class="form-control small-input">
          ...
          <div class="form-group">
            <label for="competitionLevel" class="bold-label">Hạng thi đấu</label>
            <select id="competitionLevel" v-model="searchData.competitionLevel" class="form-control small-input">
              <option value="" disabled selected>Vui lòng chọn hạng thi đấu</option>
          ...
          <div class="form-group">
            <label for="round" class="bold-label">Vòng thi đấu</label>
            <select id="round" v-model="searchData.round" class="form-control small-input">
              <option value="" disabled selected >Vui lòng chọn vòng thi đấu</option>
