<template>
    <div class="modal-overlay" @click.self="closeModal">
        <div class="modal-content">
            ...
            <h2 class="form-title">THÊM GIẢI THƯỞNG CUỘC THI</h2>
            <form @submit.prevent="submitForm">
                <div class="form-group">
                    <label for="name">Tên giải thưởng:<span class="required">*</span></label>
                    <input type="text" id="competitionName" v-model="form.competitionName" required placeholder="Vui lòng nhập tên giải thưởng...">
                </div>
                ...
                <div class="form-group">
                    <label for="price">Giá trị:<span class="required">*</span></label>
                    <input type="number" min="1" id="price" v-model="form.price" required placeholder="Vui lòng nhập giá trị...">
                </div>
