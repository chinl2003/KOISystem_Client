            ...
            <div class="table-container">
              <table class="contest-table">
                ...
                <tbody>
                  <tr>
                    <td>Vòng sơ khảo</td>
                    <td>Sức khỏe: 40%, hình dáng:30%, kích thước:30%</td>
                    <td>
                  ...
                  <tr>
                    <td>Vòng chung kết</td>
                    <td>Vẻ đẹp tổng thể:60%, phong cách bơi:40%</td>
                    <td>
                      <div class="button-group">
